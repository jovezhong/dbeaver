...
import org.jkiss.dbeaver.ext.timeplus.ui.internal.TimeplusMessages;
import org.jkiss.dbeaver.model.net.DBWHandlerConfiguration;
import org.jkiss.dbeaver.ui.UIUtils;
import org.jkiss.dbeaver.ui.dialogs.net.SSLConfiguratorTrustStoreUI;
import org.jkiss.utils.CommonUtils;

public class TimeplusSSLConfigurator extends SSLConfiguratorTrustStoreUI {
    private static final Log log = Log.getLog(TimeplusSSLConfigurator.class);
    ...
    public void createControl(@NotNull Composite parent, Object object, @NotNull Runnable propertyChangeListener) {
        ...
        Group advancedSettingsGroup = UIUtils.createControlGroup(parent,
            TimeplusMessages.dialog_connection_page_advanced_settings,
            1,
        ...
        sslModeCombo = UIUtils.createLabelCombo(sslComposite,
            TimeplusMessages.dialog_connection_page_text_ssl_mode,
            TimeplusMessages.dialog_connection_page_text_ssl_mode_tip,
            SWT.READ_ONLY
        );
    ...
    public void loadSettings(@NotNull DBWHandlerConfiguration configuration) {
        ...
        String mode = configuration.getStringProperty(TimeplusConstants.SSL_MODE_CONF);
    ...
    public void saveSettings(@NotNull DBWHandlerConfiguration configuration) {
        ...
        if (sslModeCombo != null) {
            if (!CommonUtils.isEmpty(sslModeCombo.getText())) {
                configuration.setProperty(TimeplusConstants.SSL_MODE_CONF, sslModeCombo.getText());
            }
        }
    }
}
