 ...
 */
package org.jkiss.dbeaver.ext.timeplus.ui.internal;

import org.eclipse.osgi.util.NLS;

public class TimeplusMessages extends NLS {
    static final String BUNDLE_NAME = "org.jkiss.dbeaver.ext.timeplus.ui.internal.TimeplusMessages"; //$NON-NLS-1$
    ...
    static {
        NLS.initializeMessages(BUNDLE_NAME, TimeplusMessages.class);
    }

    private TimeplusMessages() {
    }
}
