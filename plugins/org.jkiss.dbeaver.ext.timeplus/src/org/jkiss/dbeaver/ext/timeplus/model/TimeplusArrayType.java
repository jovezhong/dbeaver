...
public class TimeplusArrayType extends TimeplusAbstractDataType {
    private final DBSDataType componentType;
    private final String name;

    public TimeplusArrayType(@NotNull TimeplusDataSource dataSource, @NotNull DBSDataType componentType) {
        super(dataSource);
