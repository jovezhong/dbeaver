...
public class TimeplusCatalog extends GenericCatalog implements DBPObjectStatisticsCollector, DBPSystemObject {
    private boolean hasStatistics = true;


    public TimeplusCatalog(@NotNull GenericDataSource dataSource, @NotNull String catalogName) {
