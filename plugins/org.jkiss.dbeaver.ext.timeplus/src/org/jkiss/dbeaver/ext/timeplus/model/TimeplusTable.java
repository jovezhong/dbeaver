 ...
 * ClickhouseTable
 */
public class TimeplusTable extends GenericTable implements DBPObjectStatistics
{
    private static final Log log = Log.getLog(TimeplusTable.class);
    ...
    private TimeplusTableEngine engine;
    private String engineMessage;
    private String metadataPath;

    TimeplusTable(GenericStructContainer container, @Nullable String tableName, @Nullable String tableType, @Nullable JDBCResultSet dbResult) {
    ...
    @Nullable
    private TimeplusTableEngine searchEngine(String engineName) {
    ...
    private void setDefaultEngine() {
        final List<TimeplusTableEngine> tableEngines = getDataSource().getTableEngines();
    ...
    public TimeplusTableEngine getEngine() {
        return engine;
    }

    public void setEngine(TimeplusTableEngine engine) {
        this.engine = engine;
    }
    ...
    @NotNull
    @Override
    public TimeplusDataSource getDataSource() {
        return (TimeplusDataSource) super.getDataSource();
    }

    public static class EngineListProvider implements IPropertyValueListProvider<TimeplusTable> {
        ...
        @Override
        public Object[] getPossibleValues(TimeplusTable object) {
