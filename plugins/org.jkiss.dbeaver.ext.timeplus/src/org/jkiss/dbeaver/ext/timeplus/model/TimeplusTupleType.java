...
public class TimeplusTupleType extends TimeplusAbstractDataType implements DBSEntity {
    private final List<TimeplusTupleTypeAttribute> attributes;
    private final String name;

    public TimeplusTupleType(
    ...
    protected TimeplusTupleType(
        ...
        this.attributes = IntStream.range(0, elements.size())
            .mapToObj(index -> new TimeplusTupleTypeAttribute(
                this,
    ...
    @NotNull
    public List<TimeplusTupleTypeAttribute> getAttributes() {
        return attributes;
    }
