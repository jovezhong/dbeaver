...
public class TimeplusTupleTypeAttribute extends AbstractAttribute implements DBSEntityAttribute, DBSTypedObjectEx {
    private final TimeplusTupleType tupleType;
    private final DBSDataType attributeType;

    public TimeplusTupleTypeAttribute(
        @NotNull TimeplusTupleType tuple,
