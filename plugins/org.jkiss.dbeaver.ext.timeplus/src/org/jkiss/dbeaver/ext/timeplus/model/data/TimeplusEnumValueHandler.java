...
public class TimeplusEnumValueHandler extends JDBCStringValueHandler {
    public static final TimeplusEnumValueHandler INSTANCE = new TimeplusEnumValueHandler();
    ...
    public void bindParameter(JDBCSession session, JDBCPreparedStatement statement, DBSTypedObject paramType, int paramIndex, Object value) throws SQLException {
        ...
        if (type instanceof TimeplusTableColumn) {
            final Map<String, Integer> entries = ((TimeplusTableColumn) type).getEnumEntries();
