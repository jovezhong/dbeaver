...
public class TimeplusMapValue extends AbstractDatabaseList {
    private final TimeplusDataSource dataSource;
    private final TimeplusMapType mapType;
    private final EntryType entryType;
    private final EntryAttribute[] attributes;
    private List<EntryComposite> contents;
    private boolean modified;

    public TimeplusMapValue(
        @NotNull TimeplusDataSource dataSource,
        @NotNull TimeplusMapType type,
    ...
    private class EntryType extends AbstractStructDataType<TimeplusDataSource> implements DBSEntity {
        public EntryType(@NotNull TimeplusDataSource dataSource) {
            super(dataSource);
        }
