...
public class TimeplusStructValueHandler extends JDBCStructValueHandler {
    
    public static final TimeplusStructValueHandler INSTANCE = new TimeplusStructValueHandler();

    private static final Log log = Log.getLog(TimeplusStructValueHandler.class);
    ...
    public Object getValueFromObject(@NotNull DBCSession session, @NotNull DBSTypedObject type, Object object, boolean copy, boolean validateValue) throws DBCException {
        ...
        if (typeName.startsWith("Tuple") || typeName.startsWith("Map")) {
            try {
                return TimeplusTypeParser.makeValue(session, typeName, object);
            } catch (DBException e) {
