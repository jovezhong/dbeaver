...
public class TimeplusTupleValue implements DBDComposite, DBDValueCloneable {
    private final TimeplusTupleType type;
    private Object[] values;
    private boolean modified;

    public TimeplusTupleValue(
        @NotNull DBRProgressMonitor monitor,
        @NotNull TimeplusTupleType type,
    ...
    public DBDValueCloneable cloneValue(DBRProgressMonitor monitor) throws DBCException {
        return new TimeplusTupleValue(monitor, type, values);
    }
}
